...
<%
	...
	String filePath2 = "C:\\Java_Dev\\props\\headers\\NBVA_AssetHrdList.txt";
	...
	<div class="flex-container">
	  ...
	  <%
		...
		out.println("<tbody id=\"report\">");
		  buildCellsContract(out, contractData, formUrl, 0); // build data cells from file
		//out.println(cells);
	  ...
	  <div>Contract Totals 
	   <%
		...
		out.println("<tbody id=\"report\">");
		  buildCellsTotals(out, contractData, formUrl, 0); // build data cells from file
		//out.println(cells);
		out.println("</tbody></table><BR>"); // Close Table
